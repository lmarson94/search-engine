...
public class Indexer {
    ...
    /** The kgram index to be built by this Indexer. */
    ...
    /** Constructor */
    public Indexer( Index index, String patterns_file, KGramIndex kgramindex) {
		this.index = index;
	...
	public HashMap<String, Integer> readDoctf(String filename) {
